...
def evaluate(result_path, plot_path):
    ...
    for eta in etas:
        ...
        plt.show()
        success_agents = np.sum([1 if curve[-1] != 50 else 0 for curve in step_curves])
        print(success_agents)
...
if __name__ == "__main__":
    ...
    evaluate("results/teleportation/variant2/raw/", "results/teleportation/variant2/plot_ready/")
